    ...
    <Card className="w-full backdrop-blur-sm bg-white/5 border-0 shadow-lg h-full">
      ...
      <CardContent className="p-6 pt-0">
        <form onSubmit={handleSaveWebhook} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="webhookEvent" className="text-white">Webhook Event</Label>
            <Select 
              value={webhookEvent} 
            ...
            >
              <SelectTrigger 
                id="webhookEvent" 
                className="bg-white/10 border-white/20 text-white focus:border-white/30 focus:ring-white/30"
              >
