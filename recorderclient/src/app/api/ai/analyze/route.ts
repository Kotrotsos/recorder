...
/**
 * Handle POST requests to the /api/ai/analyze endpoint
 */
export async function POST(request: NextRequest) {
  console.log("API Route: Received analyze request");
  ...
  try {
    ...
    console.log("API Route: Analyzing text of length:", text.length);
    ...
    try {
      ...
      // Log success
      console.log("API Route: Analysis successful");
